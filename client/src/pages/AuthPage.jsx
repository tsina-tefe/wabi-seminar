  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-800 rounded-xl p-6 border border-slate-700">
        ...
        <p className="text-slate-300 mb-6">Simple real-time meeting APP</p>
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <div className="relative">
            <input
              className="w-full p-3 pr-11 rounded bg-slate-900 border border-slate-700"
            ...
            <button
              type="button"
              className="absolute right-1 top-1/2 -translate-y-1/2 rounded p-2 text-slate-400 hover:text-slate-200 hover:bg-slate-800/80"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 6.228l3.65 3.65m7.894 7.894L21 21m-3.228-6.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88"
      />
    </svg>
  );
}
